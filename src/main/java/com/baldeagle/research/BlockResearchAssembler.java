package com.baldeagle.research;
...
public class BlockResearchAssembler extends Block {
    ...
    public BlockResearchAssembler() {
        super(Material.IRON);
        setRegistryName(BaldeagleCore.MODID, "research_assembler");
        setTranslationKey("baldeaglecore.research_assembler");
        setHardness(4.5F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileEntityResearchAssembler();
    }
    ...
    public boolean onBlockActivated(
        ...
        player.openGui(
            ...
            GuiHandler.RESEARCH_ASSEMBLER_GUI_ID,
            world,
            pos.getX(),
            pos.getY(),
            pos.getZ()
    ...
    public void onBlockPlacedBy(
        ...
        if (tileEntity instanceof TileEntityResearchAssembler) {
            ...
            if (country != null) {
                ((TileEntityResearchAssembler) tileEntity).setOwnerCountry(
                    country
                );
            }
        }
